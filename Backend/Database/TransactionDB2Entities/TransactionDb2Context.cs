...
public partial class TransactionDb2Context : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseSqlServer("Data Source=LAPTOP-K14UJU5Q\\FIDEL;initial catalog=Transaction_DB_2;persist security info=True;user id=sa;password=online; TrustServerCertificate=True;");
